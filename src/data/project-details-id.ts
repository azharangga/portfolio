...
export const PROJECT_DETAILS_ID: Record<string, ProjectDetail> = {
  ...
  "siakad-ikmi": {
    ...
    gallery: [
      { image: "/projects/detail/siakad-ikmi/login.png", title: "Halaman Login", caption: "Antarmuka otentikasi masuk pengguna SIAKAD IKMI dengan sistem keamanan berbasis peran." },
      // ROLE MAHASISWA
      { image: "/projects/detail/siakad-ikmi/dashboard-mahasiswa.png", title: "Dashboard Mahasiswa", caption: "Ringkasan informasi akademik mahasiswa meliputi IPK, total SKS, status perkuliahan, dan pengumuman." },
      { image: "/projects/detail/siakad-ikmi/biodata-mahasiswa.png", title: "Halaman Biodata Mahasiswa", caption: "Manajemen dan formulir informasi profil diri serta data akademik mahasiswa." },
      { image: "/projects/detail/siakad-ikmi/hasil-cetak-biodata.png", title: "Hasil Cetak Biodata", caption: "Tampilan pratinjau cetak formulir biodata mahasiswa lengkap dengan QR Code verifikasi." },
      { image: "/projects/detail/siakad-ikmi/ktm.png", title: "Halaman KTM", caption: "Tampilan Kartu Tanda Mahasiswa digital interaktif." },
      { image: "/projects/detail/siakad-ikmi/hasil-cetak-ktm.png", title: "Hasil Cetak KTM", caption: "Dokumen siap cetak Kartu Tanda Mahasiswa (KTM) berformat resmi." },
      { image: "/projects/detail/siakad-ikmi/nilai-mahasiswa.png", title: "Halaman Nilai Mahasiswa", caption: "Daftar perolehan nilai mata kuliah mahasiswa untuk setiap semester." },
      { image: "/projects/detail/siakad-ikmi/mengisi-krs.png", title: "Halaman Pengisian KRS", caption: "Antarmuka bagi mahasiswa untuk memilih dan mengambil mata kuliah semester berjalan." },
      { image: "/projects/detail/siakad-ikmi/krs-diajukan.png", title: "KRS Diajukan", caption: "Status draft Kartu Rencana Studi yang telah diajukan mahasiswa untuk disetujui dosen pembimbing/admin." },
      { image: "/projects/detail/siakad-ikmi/krs-disetujui.png", title: "KRS Disetujui", caption: "Status Kartu Rencana Studi resmi yang telah disetujui dan divalidasi oleh pihak kampus." },
      { image: "/projects/detail/siakad-ikmi/hasil-cetak-krs.png", title: "Hasil Cetak KRS", caption: "Dokumen resmi Kartu Rencana Studi (KRS) cetak mandiri yang dilengkapi QR Code." },
      { image: "/projects/detail/siakad-ikmi/khs.png", title: "Halaman KHS", caption: "Tampilan Kartu Hasil Studi per semester beserta perolehan IPS dan akumulasi IPK." },
      { image: "/projects/detail/siakad-ikmi/hasil-cetak-khs.png", title: "Hasil Cetak KHS", caption: "Pratinjau dokumen cetak Kartu Hasil Studi (KHS) mahasiswa secara otomatis." },
      { image: "/projects/detail/siakad-ikmi/transkrip-nilai.png", title: "Halaman Transkrip Nilai", caption: "Rekapitulasi riwayat akumulasi nilai seluruh mata kuliah yang telah diambil mahasiswa." },
      { image: "/projects/detail/siakad-ikmi/hasil-cetak-transkrip-nilai.png", title: "Hasil Cetak Transkrip Nilai", caption: "Dokumen transkrip nilai akademik sementara/akhir berformat resmi dengan verifikasi QR Code." },
      { image: "/projects/detail/siakad-ikmi/skl.png", title: "Halaman SKL", caption: "Halaman pengajuan dan penerbitan Surat Keterangan Lulus bagi mahasiswa yang memenuhi syarat yudisium." },
      { image: "/projects/detail/siakad-ikmi/hasil-cetak-skl.png", title: "Hasil Cetak SKL", caption: "Dokumen Surat Keterangan Lulus (SKL) digital berlegalitas resmi." },
      { image: "/projects/detail/siakad-ikmi/chatbot.png", title: "Chatbot", caption: "Asisten kecerdasan buatan berbasis Gemini API untuk menjawab pertanyaan seputar layanan akademik." },
      // ROLE SUPERUSER / ADMIN
      { image: "/projects/detail/siakad-ikmi/dashboard-admin.png", title: "Dashboard Superuser/Admin", caption: "Pusat kendali dan rekapitulasi data statistik akademik seluruh civitas akademika." },
      { image: "/projects/detail/siakad-ikmi/program-studi.png", title: "Halaman Program Studi", caption: "Pengelolaan data jurusan dan program studi yang diselenggarakan di perguruan tinggi." },
      { image: "/projects/detail/siakad-ikmi/tahun-akademik.png", title: "Halaman Tahun Akademik", caption: "Pengaturan dan manajemen periode tahun akademik aktif beserta kurikulum berjalan." },
      { image: "/projects/detail/siakad-ikmi/mata-kuliah.png", title: "Halaman Mata Kuliah", caption: "Manajemen katalog mata kuliah, SKS, beban semester, dan prasyarat." },
      { image: "/projects/detail/siakad-ikmi/predikat-yudisium.png", title: "Halaman Predikat Yudisium", caption: "Pengaturan kriteria dan standar kelulusan serta predikat kelulusan (Cumlaude, Sangat Memuaskan, dsb.)." },
      { image: "/projects/detail/siakad-ikmi/jadwal-sidang-skripsi.png", title: "Halaman Jadwal Sidang Skripsi", caption: "Penjadwalan pelaksanaan sidang tugas akhir/skripsi mahasiswa beserta tim penguji." },
      { image: "/projects/detail/siakad-ikmi/data-pengguna.png", title: "Halaman Data Pengguna", caption: "Manajemen akun pengguna, pemberian role/hak akses, dan aktivasi akun pengguna." },
      { image: "/projects/detail/siakad-ikmi/data-mahasiswa.png", title: "Halaman Data Mahasiswa", caption: "Direktori dan manajemen data seluruh mahasiswa terdaftar." },
      { image: "/projects/detail/siakad-ikmi/import-data-mahasiswa.png", title: "Import Data Mahasiswa", caption: "Fitur unggah dan impor masal data mahasiswa baru menggunakan templat spreadsheet." },
      { image: "/projects/detail/siakad-ikmi/data-dosen.png", title: "Halaman Data Dosen", caption: "Direktori data pengajar/dosen beserta NIDN dan bidang keahlian." },
      { image: "/projects/detail/siakad-ikmi/data-pejabat.png", title: "Halaman Data Pejabat", caption: "Pengelolaan struktur pejabat kampus (Ketua, Waket, Kaprodi) untuk penandatanganan dokumen resmi." },
      { image: "/projects/detail/siakad-ikmi/cetak-masal-biodata.png", title: "Cetak Masal Biodata", caption: "Fasilitas cetak sekaligus dokumen biodata mahasiswa dalam jumlah besar." },
      { image: "/projects/detail/siakad-ikmi/cetak-masal-ktm.png", title: "Cetak Masal KTM", caption: "Fasilitas per generasi dan pencetakan masal Kartu Tanda Mahasiswa (KTM)." },
      { image: "/projects/detail/siakad-ikmi/data-mbkm.png", title: "Halaman Data MBKM", caption: "Pengelolaan partisipasi dan penyetaraan kegiatan Merdeka Belajar Kampus Merdeka." },
      { image: "/projects/detail/siakad-ikmi/kelola-nilai-mahasiswa.png", title: "Halaman Kelola Nilai Mahasiswa", caption: "Pusat pengelolaan dan pengawasan nilai akhir mata kuliah mahasiswa." },
      { image: "/projects/detail/siakad-ikmi/input-nilai-mahasiswa.png", title: "Input Nilai Mahasiswa", caption: "Formulir penginputan nilai komputasi (Tugas, UTS, UAS, Presensi) per mata kuliah." },
      { image: "/projects/detail/siakad-ikmi/import-nilai-mahasiswa.png", title: "Import Nilai Mahasiswa", caption: "Fasilitas unggah dan impor masal nilai perkuliahan dari file Excel." },
      { image: "/projects/detail/siakad-ikmi/validasi-krs.png", title: "Halaman Validasi KRS Mahasiswa", caption: "Daftar pengajuan KRS mahasiswa yang membutuhkan persetujuan/validasi administrator." },
      { image: "/projects/detail/siakad-ikmi/validasi-krs-mahasiswa.png", title: "Validasi KRS Mahasiswa", caption: "Detail peninjauan dan persetujuan pengajuan mata kuliah per mahasiswa." },
      { image: "/projects/detail/siakad-ikmi/input-krs-kolektif.png", title: "Input KRS Kolektif", caption: "Fitur pengisian dan penetapan paket KRS secara serentak untuk satu rombel/angkatan." },
      { image: "/projects/detail/siakad-ikmi/cetak-masal-khs.png", title: "Cetak Masal KHS", caption: "Fasilitas cetak masal dokumen Kartu Hasil Studi per kelas atau angkatan." },
      { image: "/projects/detail/siakad-ikmi/cetak-masal-transkrip.png", title: "Cetak Masal Transkrip", caption: "Fasilitas pencetakan masal dokumen transkrip nilai akademik mahasiswa." },
      { image: "/projects/detail/siakad-ikmi/cetak-masal-skl.png", title: "Cetak Masal SKL", caption: "Fasilitas penertiban dan pencetakan masal Surat Keterangan Lulus untuk wisudawan." },
      { image: "/projects/detail/siakad-ikmi/manajemen-menu.png", title: "Halaman Manajemen Menu", caption: "Pengaturan struktur navigasi dan otorisasi menu aplikasi." },
      { image: "/projects/detail/siakad-ikmi/atur-urutan-menu.png", title: "Atur Urutan Menu", caption: "Fitur drag-and-drop untuk mengatur hirarki dan urutan menu antarmuka." },
      { image: "/projects/detail/siakad-ikmi/status-sistem.png", title: "Halaman Status Sistem", caption: "Pemantauan kondisi server, kesehatan database, dan metrik performa sistem." },
      { image: "/projects/detail/siakad-ikmi/Manajemen-api-key.png", title: "Halaman Manajemen API Key", caption: "Pengelolaan kunci akses API dan integrasi layanan pihak ketiga." },
      { image: "/projects/detail/siakad-ikmi/pengaturan-akun.png", title: "Halaman Pengaturan Akun", caption: "Pengaturan profil admin, ubah kata sandi, dan preferensi akun." },
    ]
  },
  datadikti: {
    slug: "datadikti",
