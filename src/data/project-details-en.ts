...
export const PROJECT_DETAILS_EN: Record<string, ProjectDetail> = {
  ...
  gizimeal: {
    ...
    contributors: [
      { name: "Azharangga Kusuma", role: "AI Engineer and Project Manager", avatar: "/team/azhar.jpg", github: "https://github.com/azharangga", linkedin: "https://linkedin.com/in/azharangga" },
    ...
    gallery: [
      { image: "/projects/detail/gizimeal/gizimeal.png", title: "Main Landing Interface", caption: "Interactive dashboard highlighting calorie calculator and meal log entries." },
      { image: "/projects/detail/gizimeal/gizimeal-model.png", title: "AI Model Stats Dashboard", caption: "Detailed look at CNN validation curves and multi-task predictions." }
    ]
  },
  dramova: {
    slug: "dramova",
  ...
  "siakad-ikmi": {
    ...
    solutionApproach: {
      ...
      techExplanation: "Built with Next.js (App Router), React, and Tailwind CSS. The backend uses Supabase (PostgreSQL) for secure user management and academic records. The chatbot integrates Google Gemini API with custom system prompts to ensure responses strictly adhere to verified campus guidelines.",
      workflow: [
    ...
    gallery: [
      { image: "/projects/detail/siakad-ikmi/siakad-ikmi.png", title: "Student Dashboard", caption: "Clean interface displaying GPA progress, active KRS, and calendar events." }
    ]
  },
  datadikti: {
    slug: "datadikti",
